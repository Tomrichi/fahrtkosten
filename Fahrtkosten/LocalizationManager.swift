...
let translations: [AppLanguage: [String: String]] = [
    .german: [
        ...
        "settings.km.footer": "Steuerlicher Höchstsatz 2024: 0,30 € / km für Pkw",
    ...
    .english: [
        ...
        "settings.km.footer": "Tax maximum 2024: 0.30 € / km for cars",
    ...
    .polish: [
        ...
        "settings.km.footer": "Maksimum podatkowe 2024: 0,30 € / km dla samochodów",
    ...
    .czech: [
        ...
        "settings.km.footer": "Daňové maximum 2024: 0,30 € / km pro osobní automobily",
