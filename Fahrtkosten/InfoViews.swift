...
<details>
  <summary>
    ...
    <span class="build-info">21. Juli 2026 · Build 39</span>
    <span class="chevron">›</span>
  </summary>
  <div class="detail-content">
    <ul>
      <li><span class="badge-fix">FIX</span> <strong>Wochenend-Schutz nachgebessert:</strong> Statt nur „Ich habe gearbeitet" bestätigen zu können, wird jetzt zwischen „Gearbeitet" (Wochenendzulage gilt) und „Unterwegs/nicht zuhause – nur Pauschale" (normale Verpflegungspauschale ohne Wochenendzulage) unterschieden. So lässt sich die Pauschale auch an Wochenendtagen erfassen, an denen man zwar unterwegs/nicht zuhause, aber nicht tatsächlich im Einsatz war.</li>
    </ul>
  </div>
</details>
