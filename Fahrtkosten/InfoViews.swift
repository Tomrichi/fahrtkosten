...
<p>Fällt das gewählte Datum auf einen Samstag oder Sonntag, muss vor dem Speichern gewählt werden: „Gearbeitet" (dann gilt zusätzlich die Wochenendzulage) oder „Unterwegs/nicht zuhause – nur Pauschale" (dann gilt nur die normale Verpflegungspauschale, keine Wochenendzulage) – so verhindern Tippfehler beim Datum versehentliche Wochenend-Einträge, ohne die berechtigte Pauschale für reine Abwesenheitstage zu blockieren.</p>
...
<details>
  <summary>
    ...
    <span class="build-info">31. August 2026 · Build 46</span>
    <span class="chevron">›</span>
  </summary>
  <div class="detail-content">
    <ul>
      <li><span class="badge-new">NEU</span> <strong>Frühstück im Hotel:</strong> Ist das Frühstück im Hotelpreis enthalten, reicht ein Haken – die App zieht 20 % der Verpflegungspauschale automatisch ab (§ 9 Abs. 4a EStG, gilt für in Deutschland angestellte Techniker).</li>
      <li><span class="badge-new">NEU</span> <strong>Frisches Farbdesign:</strong> Übernachtungen, Fahrten, Leasing und KFZ-Steuer erscheinen jetzt in einem klaren Blau.</li>
      <li><span class="badge-fix">FIX</span> <strong>GPS – Sekündliche Aktualisierung:</strong> CarPlay und iPhone aktualisierten sich nur alle 4–5 Sekunden statt sekündlich.</li>
      <li><span class="badge-fix">FIX</span> <strong>GPS – Kraftstoffdaten komplett:</strong> Nach Beenden einer GPS-Fahrt werden Kraftstofftyp, Preis und Verbrauch aus den Einstellungen vollständig übernommen.</li>
      <li><span class="badge-fix">FIX</span> <strong>GPS – Streckenanzeige:</strong> Unter 1 km wird die Strecke jetzt in 100-Meter-Schritten angezeigt (z. B. 300 m, 400 m).</li>
    </ul>
  </div>
</details>
...
<details>
  <summary>
    <div class="summary-inner">
      ...
      <div class="preview-text">CarPlay: Tempo zuerst, Pause-Button, Auto-Start · GPS-Meteranzeige</div>
    </div>
    <span class="build-info">11. August 2026 · Build 34</span>
    <span class="chevron">›</span>
  </summary>
  <div class="detail-content">
    <ul>
      <li><span class="badge-new">NEU</span> <strong>CarPlay – Tempo an erster Stelle:</strong> Die Geschwindigkeit steht jetzt ganz oben im CarPlay-Dashboard und aktualisiert sich sekündlich.</li>
      <li><span class="badge-new">NEU</span> <strong>CarPlay – Pause-Button:</strong> GPS-Fahrt direkt am Autodisplay pausieren und fortsetzen.</li>
      <li><span class="badge-new">NEU</span> <strong>CarPlay – Auto-Start:</strong> GPS-Aufzeichnung startet automatisch beim Verbinden mit CarPlay (Einstellungen → GPS / CarPlay).</li>
      <li><span class="badge-new">NEU</span> <strong>GPS – Große Geschwindigkeitsanzeige:</strong> Tempo wird während der Aufzeichnung prominent auf dem iPhone angezeigt.</li>
      <li><span class="badge-new">NEU</span> <strong>GPS – Meteranzeige:</strong> Strecken unter 1 km werden in Metern angezeigt, ab 1 km mit einer Nachkommastelle.</li>
      <li><span class="badge-fix">FIX</span> <strong>GPS – Kraftstofftyp:</strong> Eingestellter Kraftstofftyp wird nach GPS-Fahrt automatisch übernommen.</li>
    </ul>
  </div>
</details>
...
<details>
  <summary>
    <div class="summary-inner">
      ...
      <div class="preview-text">Monteurszulage Stundenregel · GPS-Geschwindigkeit · iOS 18 Fix</div>
    </div>
  ...
  <div class="detail-content">
    <ul>
      <li><span class="badge-new">NEU</span> <strong>Monteurszulage – Stundenregel:</strong> Die Zulage richtet sich jetzt nach der tatsächlichen Einsatzdauer – unter 3 Stunden keine Zulage, 3–6 Stunden 50 % der Pauschale, ab 6 Stunden volle Zulage.</li>
      <li><span class="badge-new">NEU</span> <strong>GPS – Geschwindigkeitsanzeige:</strong> Aktuelle Geschwindigkeit wird während der Aufzeichnung auf dem iPhone angezeigt.</li>
      <li><span class="badge-fix">FIX</span> <strong>iOS 18 – Tab-Leiste:</strong> Karteninhalt schimmerte durch den Hintergrund der schwebenden Tab-Leiste.</li>
    </ul>
  </div>
</details>
